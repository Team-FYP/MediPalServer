  ...
  <div class="sp-container">
    <div class="sp-content">
      <div class="sp-wrap sp-left">
        <h2>
          <span class="sp-top">What if you wouldn't suffer</span>
          <span class="sp-mid">allergy</span>
      ...
      <div class="sp-wrap sp-right">
        <h2>
          ...
          <span class="sp-mid">critical<i>!</i><i>?</i></span>
          <span class="sp-bottom">Yeah, it would!</span>
        </h2>
      </div>
    </div>
    <div class="sp-full">
      <h2>You will not suffer from allergies anymore!</h2>
      <a><img src="images/medipal_logo.png" style="width: 200px; height: 150px"></a>
    </div>
  </div>
</div>
</body>
